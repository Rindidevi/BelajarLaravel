...
class othercontroller extends Controller
{
    ...
    public function postTambahDosen(Request $request)
    {
        ...
        // Menyimpan objek dosen ke database
        $dosen->save();
    ...
    {
        // Mengambil data dosen yang akan diedit berdasarkan ID
        $data = Dosen::find($id);
        // Menampilkan halaman edit dosen dengan data dosen yang dipilih
        return view('admin.editDosen', compact('data'));
    }

    public function postEditDosen(Request $request, $id)
    {
        // Validasi data yang diinputkan oleh pengguna untuk edit bdosen
        $request->validate([
            'NIP' => 'required',
            'Nama' => 'required',
            'ProgramStudi' => 'required',
        ...
        // Mengisi properti-properti objek dosen dengan data dari formulir edit
        $dosen->NIP = $request->NIP;
        $dosen->Nama = $request->Nama;
        $dosen->ProgramStudi = $request->ProgramStudi;
    ...
    {
        $dosen = Dosen::find($id); // Mengambil data dosen yang akan dihapus berdasarkan ID
        if ($dosen->gambar) { // Menghapus gambar yang terkait dengan dosen
