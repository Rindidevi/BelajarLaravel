        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('user.lihatLulusan') }}">Lulusan</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-2">
                        <img style="width: 150px" src="{{ asset('images/' . $lulusan->gambar) }}" alt="gambar lulusan">
