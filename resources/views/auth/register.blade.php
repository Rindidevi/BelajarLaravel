            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('postRegister') }}" method="POST">
                    ...
                    <div class="form-group mt-4">
                        ...
                        <input type="text" class="form-control border bordersecondary form-control-lg" name="name"
                    ...
                    <br>
                    <br>
                    <button type="submit" class=" form-control btn btn-custom mt5">Register</button>
                </form>
                <p class="mt-2 text-center">Sudah punya akun? <a href="{{
route('auth.login') }}" style="text-decoration: none; color : #888;">Ayo
                        masuk!</a></p>
            </div>
        </div>
    </div>
