                        ...
                        <form action="{{ route('postBerita') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="text" class="form-control border border-secondary form-control"
                                    name="judulberita" required value="{{ old('judulberita') }}">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <textarea class="form-control" name="isiberita"
                                    placeholder="Tulis deskripsi berita disini...." style="height: 250px" required
