        ...
        <div class="container mt-3">
            <div class="row mt-4">
                ...
                <div class="col-6">
                    <form action="{{ route('admin.lulusan') }}" method="GET">
                        ...
                        <div class="input-group">
                            <input type="search" name="search" class="form-control rounded" placeholder="Cari nama Mahasiswa" aria-label="Search" aria-describedby="search-addon" />
                ...
                <div class="col-3 text-end">
                    <a class="btn btn-success" href="{{ route('admin.tambahLulusan') }}" style=" width: 150px;">Tambah
                        Data
                        +</a>
                </div>
                <!-- Button Logout -->
        ...
        <table class="table" style="margin-top: 10px">
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    ...
                    <td>
                        <!-- Menampilkan foto lulusan-->
                        <img style="width: 50px" src="{{ asset('images/' . $lulusan->gambar) }}" alt="foto lulusan">
                    </td>
                    <td>{{ $lulusan->NIM}}</td>
                    <td>{{ $lulusan->Nama}}</td>
                    <td>{{ $lulusan->ProgramStudi}}</td>
                    <td>{{ $lulusan->IPK}}</td>
                    <td>
